...
CoD.PrivateGameLobby.Dvars[1].name = "MIN PLAYERS" -- todo localize
CoD.PrivateGameLobby.Dvars[1].hintText = "The game will wait at the loadscreen until the amount of players ingame is reached." -- todo localize
...
CoD.PrivateGameLobby.Dvars[3].name = "CHEATS" -- todo localize
CoD.PrivateGameLobby.Dvars[3].hintText = "Enable cheats on server." -- todo localize
